    ...
    <div class="container">
        ...
        <form method="post" action="{{route('staffs.store')}}">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select name="staffGroup" class="form-control" value="{{ old('staffGroup')}}" placeholder="Nhập nhóm nhân viên">
            ...
            <div class="row">
                ...
                <div class="form-group">
                <label>Số CMND</label>
                <input type="number" name="CMND" class="form-control" value="{{ old('CMND')}}" placeholder=" Nhập số chứng minh nhân dân">
                @if ($errors->any())
            ...
            <div class="row">
                ...
                <input type="date" name="birthday" class="form-control" value="{{ old('birthday')}}" placeholder=" Nhập ngày sinh">
                @if ($errors->any())
